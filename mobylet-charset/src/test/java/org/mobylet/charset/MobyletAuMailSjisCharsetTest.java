...
public class MobyletAuMailSjisCharsetTest extends TestCase {

	public void test_encodeMatchWindows31J() {
		//## ARRANGE ##
		Charset charset = new MobyletAuMailSjisCharset();
	...
	public void test_encodeMatchEmoji() {
		...
		assertEquals(bEncodeM[0] & 0xFF, 0xEB);
	...
	public void test_decodeMatchEmoji() {
		//## ARRANGE ##
		Charset charset = new MobyletAuMailSjisCharset();
		CharBuffer decode = charset.decode(ByteBuffer.wrap(new byte[]{(byte)0xEB, (byte)0x59}));
